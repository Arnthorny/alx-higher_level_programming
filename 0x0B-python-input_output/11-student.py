...
class that defines a student based on the 10-student module.
"""
...
class Student:
    ...
    def reload_from_json(self, json):
        ...
        Args:
            json(:`object`:`dictionary`): Dictionary containing
            replacements

        A dictionary key will be the public attribute name
        A dictionary value will be the value of public attribute.
        """
